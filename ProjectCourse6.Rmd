...
data = subset(data, logFC.WCFS1.glc...WCFS1.rib <= -1 | logFC.WCFS1.glc...WCFS1.rib >= 1)
              
data = subset(data, logFC.NC8.glc...NC8.rib <= -1 |  logFC.NC8.glc...NC8.rib >= 1)
...
Aantal genen na filteren: `r dim(data)[1]`
...
```{r}
mypathway <- "lpl00010"
genes <- row.names(data$ORF)
logFC <- data$logFC.WCFS1.glc...WCFS1.rib
names(logFC) <- genes
