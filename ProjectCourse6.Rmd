...
### P-waarde berekenen
```{r}
# Hier is code om eerst een contrast te berekenen en
# fold-changes te berekenen! EN de P-waardes berekenen!
...
### Print top tags
```{r}
# TopTags berekend ook de FDR.
res<-topTags(fit)
print(res)

# Originele counts met log en annotatie koppelen.
# Dan filteren op FDR alles lager dan 0.5.
# Dan filteren op LogFC tussen -1 en 1.
# sorteren op FDR.
# In heatmap de counts weergeven van gefilterde data.
# kijken hoeveel data na filteren.
# Hoeveel naar ribose en hoeveel naar glucose? data bekijken.
# Meer inzicht krijgen in wat wat doet en resultaten bekijken.
# Focus op data en kijken wat ik zie, niet pakketten valideren.
# KEGG-mapper kan gebruikt worden van docent.
```
