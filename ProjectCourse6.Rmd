...
#df=data.frame(group=rep(c("A","B"),5), value1=1:10,value2=21:30,value3=41:50,stringsAsFactors = F)
#df
#>>>>>>> e0b8d43b0672e39af547a7ccb05b91cbba4f1330
#=======
#df=data.frame(group=rep(c("A","B"),5), #value1=1:10,value2=21:30,value3=41:50,stringsAsFactors = F)
#df
# hallo github
#df=data.frame(group=rep(c("A","B"),5), value1=1:10,value2=21:30,value3=41:50,stringsAsFactors = F)
#df
#>>>>>>> f228996f38eab90efb44e50d99c4bfc359e31d83
...
=======
>>>>>>> ec4f3e1871fe9be69577eb31a1264b6a00051e5c
### P-waarde berekenen
```{r}
...
dend 
plot(dend )# %>% set("labels", c("WCFS1.glc.2", "NC8.glc.1", "NC8.rib.2", "WCFS1.rib.1", "WCFS1.rib.2", "NC8.rib.1", "WCFS1.glc.1", "NC8.glc.1")) %>% plot
=======
# code Karsten
c_data = t(x$counts)
...
```{r}
norm_1 <-as.data.frame(t(y$counts))
norm_labels = names(norm_1)
names(norm_1) <- NULL



norm_sc = as.data.frame(scale(norm_1))
d <- dist(norm_sc, method='euclidean')
